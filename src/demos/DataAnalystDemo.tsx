...
import { FileSpreadsheet, ChevronDown, Users, Package, TrendingUp, BarChart3 } from 'lucide-react';
...
export default function DataAnalystDemo() {
  ...
  const generateResponse = (question: string): { content: string; chartType: ChartType } => {
    ...
    return {
      content: 'ご質問ありがとうございます。現在選択されているデータに関連する質問をお試しください。\n\nプリセットボタンをクリックすると、代表的な分析を実行できます。',
      chartType: null,
    };
  };
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col max-w-6xl mx-auto w-full bg-white border-x border-gray-200 overflow-hidden">
        <ChatInterface
          messages={messages}
